...
$panggil="SELECT * from `mata kuliah`";
$hasil=mysqli_query($con,$panggil);
echo"<h4>DATA MATA KULIAH</H4>";
echo "<table width='600' border='1'>
 <tr bgcolor='green'><th>No</th>
 <th>Kode Mata Kuliah</th>
 <th>Nama Mata Kuliah</th><th>Semester</th>
 <th>Bobot SKS</th></tr>";
$nomer_urut=0; 
...
$nomer_urut++;
echo "<tr><td>$nomer_urut</td><td>$kode_mk</td>
 <td>$nama_mk</td><td 
align='center'>$semester</td>
