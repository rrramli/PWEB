...
<form action="<?php echo $server;?>" method="post">
 ...
 <td width="431"><input type="text" name="no_ktp" 
id="textfield"></td>
 </tr>
 <tr>
...
value="Perempuan"> 
 ...
 <td valign="top">:</td>
 <td><input type="text" name="usia" id="textfield3"> 
 Tahun</td>
 </tr>
 <tr>
...
$usia=$_POST['usia'];
$alamat=$_POST['alamat'];
$masuk="INSERT into penduduk (no_ktp, nama, 
 jenis_kelamin, agama, usia, alamat) VALUES 
 ('$no_ktp','$nama','$jk','$agama','$usia','$alamat')";
$hasil=mysqli_query($mysqli,$masuk);
?>
