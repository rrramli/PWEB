...
<form action="<?php echo $server;?>" method="post">
 ...
 <td width="8">:</td>
 <td width="203"><input type="text" name="kode_mk" 
id="textfield"></td>
 </tr>
 <tr>
 <td>Nama Mata Kuliah</td>
 <td>:</td>
 <td><input type="text" name="nama_mk" 
id="textfield2"></td>
 </tr>
 <tr>
 <td>Semester</td>
...
id="textfield3"></td>
 ...
 <td>Bobot SKS</td>
 <td>:</td>
 <td><input type="int" name="jumlah_sks" id="textfield4"></td>
 </tr>
 <tr>
 <td> </td>
 <td> </td>
...
$query="INSERT into `mata kuliah` (kode_mk, nama_mk, 
semester, jumlah_sks) VALUES 
